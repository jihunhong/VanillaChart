...
function fetchBugsCharts({ page }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const artists = yield page.$$eval('p.artist > a:nth-of-type(1)', artists => artists.map((el) => el.getAttribute('title')));
...
function fetchAlbumInfo({ page, albumId }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const artistName = yield page.$eval('.info td', el => el.textContent);
